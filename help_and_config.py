...
class HelpAndConfig():
    ...
    def __init__(self, master):
        ...
        self.add_label(self._label_1, "Command", wraplength=row_0_width)
        self.add_label(self.label_1, "Description", column=1)
        self.add_label(self._label_2, "Shift+D", wraplength=row_0_width)
        self.add_label(self.label_2, "Show image details", column=1)
        self.add_label(self._label_3, "Home", wraplength=row_0_width)
        self.add_label(self.label_3, "Reset image browser", column=1)
        self.add_label(self._label_4, "Page Up/Page Down", wraplength=row_0_width)
        self.add_label(self.label_4, "Page through images", column=1)
        self.add_label(self._label_5, "Shift+M", wraplength=row_0_width)
        self.add_label(self.label_5, "Add or remove a mark for current image", column=1)
        self.add_label(self._label_6, "Shift+N", wraplength=row_0_width)
        self.add_label(self.label_6, "Add all marks between most recently set and current file", column=1)
        self.add_label(self._label_7, "Shift-G", wraplength=row_0_width)
        self.add_label(self.label_7, "Go to next mark", column=1)
        self.add_label(self._label_14, "Shift+C", wraplength=row_0_width)
        self.add_label(self.label_14, "Copy marks list", column=1)
        self.add_label(self._label_15, "Ctrl+M", wraplength=row_0_width)
        self.add_label(self.label_15, "Move marks to directory", column=1)
        self.add_label(self._label_8, "Left/Right Arrow", wraplength=row_0_width)
        self.add_label(self.label_8, "Show previous/next image", column=1)
        self.add_label(self._label_9, "Mouse Wheel Up/Down", wraplength=row_0_width)
        self.add_label(self.label_9, "Show previous/next image", column=1)
        self.add_label(self._label_10, "Shift-Left/Right Arrow", wraplength=row_0_width)
        self.add_label(self.label_10, "Show previous/next group", column=1)
        self.add_label(self._label_11, "Shift-Enter", wraplength=row_0_width)
        self.add_label(self.label_11, "Open image location", column=1)
        self.add_label(self._label_12, "Shift-Delete / Mouse Wheel Click", wraplength=row_0_width)
        self.add_label(self.label_12, "Delete image", column=1)
        self.add_label(self._label_13, "F11", wraplength=row_0_width)
        self.add_label(self.label_13, "Toggle fullscreen", column=1)
        self.add_label(self._label_14, "", wraplength=row_0_width)
        ...
        self.add_label(self.label_show_toasts, "Show Toasts", wraplength=row_0_width)
        self.add_checkbox(self.checkbox_show_toasts)
        self.add_label(self.label_slideshow_interval_seconds, "Slideshow Interval (sec)", wraplength=row_0_width)
        self.apply_to_grid(self.entry_slideshow_interval_seconds, sticky=W, column=1)
        self.add_label(self.label_file_check_interval_seconds, "File Check Interval (sec)", wraplength=row_0_width)
        self.apply_to_grid(self.entry_file_check_interval_seconds, sticky=W, column=1)
        self.add_label(self.label_sort_by, "Sort By", wraplength=row_0_width)
        self.add_label(self.sort_by, str(config.sort_by), column=1)
        self.add_label(self.label_toasts_persist_seconds, "Toasts Persist (sec)", wraplength=row_0_width)
        self.apply_to_grid(self.entry_toasts_persist_seconds, sticky=W, column=1)
        self.add_label(self.label_delete_instantly, "Delete Instantly", wraplength=row_0_width)
        self.add_checkbox(self.checkbox_delete_instantly)
        self.add_label(self.label_trash_folder, "Trash Folder", wraplength=row_0_width)
        self.apply_to_grid(self.entry_trash_folder, sticky=W, column=1)
        self.add_label(self.label_image_tagging_enabled, "Image Tagging Enabled", wraplength=row_0_width)
        self.add_checkbox(self.checkbox_image_tagging_enabled)
        self.add_label(self.label_escape_backslash_filepaths, "Escape Backslash Filepaths", wraplength=row_0_width)
