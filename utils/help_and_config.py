...
class HelpAndConfig():
    ...
    def __init__(self, master):
        ...
        self.label_title_notify_persist_seconds = Label(self.frame)
        self.title_notify_persist_seconds = StringVar(value=str(config.title_notify_persist_seconds))
        self.entry_title_notify_persist_seconds = self.new_entry(self.title_notify_persist_seconds)
        ...
        self.add_label(self.label_enable_prevalidations, _("Enable Prevalidations"), wraplength=col_0_width)
        self.add_checkbox(self.checkbox_enable_prevalidations)
        ...
        self.add_label(self.label_title_notify_persist_seconds, _("Title Notify Persist (sec)"), wraplength=col_0_width)
        self.apply_to_grid(self.entry_title_notify_persist_seconds, sticky=W, column=1)
