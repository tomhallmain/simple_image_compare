...
In PySide6, QScrollArea already provides native scroll support with 
automatic scroll-bar management and mouse wheel forwarding, so heavy
lifting is unnecessary.
